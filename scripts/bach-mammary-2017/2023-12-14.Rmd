...
for (i in seq_along(accessions)) {
    ...
    current.counts <- as(current.counts, "SVT_SparseMatrix")
    type(current.counts) <- "integer"
...
sce <- SingleCellExperiment(list(counts=final.counts), rowData=collected.rowdata[[1]], colData=final.coldata)
...
saveDataset(sce, "finished",
    createMetadata(
        ...
        taxonomy.id="10090",
        genome="GRCm38",
        sources=list(list(provider="GEO", id="GSE106273")),
