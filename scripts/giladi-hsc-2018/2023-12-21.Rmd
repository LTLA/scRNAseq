...
We obtain a single-cell RNA sequencing dataset of haematopoietic stem cells from [Giladi et al. (2018)](https://doi.org/10.1038/s41556-018-0121-4).
...
Filling in the column data as well.
...
Unfortunately the RNA and CRISPR data don't pertain to the same set of cells.
I'll make the executive decision of taking the intersection to combine them into a single SCE.
...
Check that the amplification batches are the same, in which case we don't need to save the CRISPR column data.
