...
We extract the reduced dimensions into their own category.
...
We assemble each organ-specific `SingleCellExperiment`:
...
for (tissue in names(all.counts)) {
    ...
    reducedDim(sce, "TSNE", withDimnames=FALSE) <- tsne[ref.names,]
