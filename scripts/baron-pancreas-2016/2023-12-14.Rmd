...
library(scRNAseq)
meta <- createMetadata(
    title="[subset] A Single-Cell Transcriptomic Map of the Human and Mouse Pancreas Reveals Inter- and Intra-cell Population Structure",
...
copy$genome <- "GRCh38"
saveDataset(sce, "finished/human", copy)
```
...
copy$genome <- "GRCm38"
saveDataset(sce, "finished/mouse", copy)
```
