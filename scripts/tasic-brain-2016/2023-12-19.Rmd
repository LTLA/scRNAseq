...
This dataset is represented by a `SingleCellExperiment` with spike-in data stored in the alternative experiment. Note that some of the spike-in rows have missing observations for some (but not all) cells. The last 9 cells (containing `_CTX_` in their names) correspond to no-cell control libraries.",
        taxonomy.id="10090",
        genome="GRCm38",
        sources=list(
