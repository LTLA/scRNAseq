---
title: Fixing the Tasic brain dataset
author: Aaron Lun
---
...
For some reason, I saved the alternative experiment as a `SummarizedExperiment` instead of a `SingleCellExperiment`.
...
gypsum::cloneVersion("scRNAseq", "tasic-brain-2016", "2023-12-19", destination=tmp)
```
...
Running our update script on the alternative experiment:
