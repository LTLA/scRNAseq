...
Maintainer note: this dataset contains only the pancreas cells from the study. The sorting protocol and donor identity for each cell were obtained from the sample annotations in the GEO entry. ERCC spike-in molecule counts were computed with a volume of 20 nL per cell and a dilution of 50000.",
        taxonomy.id="9606",
        genome="GRCh37",
        sources=list(
