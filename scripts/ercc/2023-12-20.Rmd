...
Maintainer note: concentrations obtained from Thermo Fisher Scientific using the catalog number 4456740.",
        taxonomy.id=list(),
        genome=list(),
        sources=list(
            list(provider="other", id=url),
            list(provider="other", id="https://www.thermofisher.com/order/catalog/product/4456740") # links to the former
        ),
