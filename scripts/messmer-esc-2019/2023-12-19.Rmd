...
We assemble it all into a `SingleCellExperiment` with spike-ins stored in an alternative experiment:
...
This dataset is represented by a `SingleCelLExperiment` where technical replicates for the same cell have been summed together. The spike-in counts are also stored in an alternative experiment.",
        taxonomy.id="9606",
        genome="GRCh38",
        sources=list(
