...
dir.create("finished")
dir.create(file.path("finished", "pbmc"))
dir.create(file.path("finished", "mixture"))
```
...
saveDataset(pbmc.rna.sce, file.path("finished", "pbmc", "rna"), copy)
```
...
saveDataset(hto.se, file.path("finished", "pbmc", "hto"), copy)
```
...
saveDataset(igg.se, file.path("finished", "pbmc", "igg"), copy)
```
...
saveDataset(adt.se, file.path("finished", "pbmc", "adt"), copy)
```
...
saveDataset(sce, file.path("finished", "mixture", "rna"), copy)
```
...
saveDataset(hto.se, file.path("finished", "mixture", "hto"), copy)
```
