...
We set up some common metadata and a directory for creating outputs later:

```{r}
unlink("2023-12-18", recursive=TRUE)
dir.create("2023-12-18")
...
saveDataset(sce.416b, "2023-12-18/416b", copy)
```
...
saveDataset(sce.tropho, "2023-12-18/tropho", copy)
```
