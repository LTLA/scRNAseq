...
#' bibfile character(1) path to bibtex
#' has.pmids logical(1) if TRUE, href tags will be generated using the pmid attribute
#' of entries
...
datasetsPage = function() {
  ...
  nndf = left_join(ndf, bibdf, by="tag")
  taxmap = c("8355"="Xenopus laevis", "9606"="Homo sapiens", "10090"="Mus musculus")
  newdf = data.frame(org=taxmap[as.character(nndf$Taxonomy)],
