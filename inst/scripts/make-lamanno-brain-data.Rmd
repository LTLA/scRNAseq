...
Counts for cells from adult and embryo mice are available from the Gene Expression Omnibus 
...
We save all of the relevant components of `sce` to file for upload to `r Biocpkg("ExperimentHub")`.
