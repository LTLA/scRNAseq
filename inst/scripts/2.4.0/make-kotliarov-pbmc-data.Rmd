...
Of particular interest is the `H1_day0_demultilexed_singlets.RDS` file, which is a Seurat object that contains demultiplexed counts (filtered for singlets). Demultiplexing was performed with hashtag-oligo counts, and verified with demuxlet. Counts available have not been normalized.
